...
import { Content, type KeyTextField } from "@prismicio/client";
    ...
    >
      <div className="grid min-h-[70vh] grid-cols-1 md:grid-cols-2 items-center">
        ...
        <div className="col-start-1 md:row-start-1">
          <h1
            className="mb-8 text-[clamp(3rem,20vmin,20rem)] font-extrabold tracking-tighter leading-none"
            aria-label={
          ...
          >
            ...
            <span className="block -mt-[.2em] text-slate-500">
